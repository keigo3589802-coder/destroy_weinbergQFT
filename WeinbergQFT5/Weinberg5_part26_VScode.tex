...
\end{align*}
のもとで不変である．($A$はスカラーだが$B$は擬スカラーである．)パリティ保存が「偶発的」な対称性として現れるというのは様々なくりこみ可能なゲージ理論でよくある(12.5節と18.7節)が，スピンゼロの場を服ｘだ理論についてはそうではない．したがって，これは単一のスカラー超場$S$のくりこみ可能な理論において，超対称性の特別な場合だということができる．
